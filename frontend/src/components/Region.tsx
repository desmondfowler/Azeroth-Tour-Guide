...
export default function Region({
  ...
  const factionClass = useMemo(
    () =>
      factionStyles[faction as keyof typeof factionStyles] ||
      factionStyles.Unknown,
    [faction]
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 4px 15px rgba(0, 0, 0, 0.5), inset 0 0 10px rgba(255, 193, 7, 0.1)",
        minHeight: "100%",
    ...
    >
      ...
      <div className="flex items-center mb-3">
        <span className="text-sm font-semibold text-amber-300 mr-2">
          Faction:
        </span>
        <span
