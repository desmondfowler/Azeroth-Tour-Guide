    ...
    return (
        <main className="flex-grow py-12 bg-gray-900">
            <div className="text-center">
                ...
                <div className="mx-auto max-w-4xl text-gray-300 rounded-lg bg-gray-800 p-8 shadow-xl border border-amber-700">                    <p>
                    ...
                    <p className="mt-6">
                        <a href="/azeroth" className="inline-block bg-amber-600 text-gray-900 font-bold px-6 py-3 rounded-lg shadow-lg hover:bg-amber-700 transition-all">                            Start Exploring
                        </a>
                    </p>
                </div>
            </div>
